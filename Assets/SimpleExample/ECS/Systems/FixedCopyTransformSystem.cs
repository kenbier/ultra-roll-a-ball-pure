...
namespace SimpleExample.ECS
{
	...
	// Update after initial copy
	[UpdateAfter(typeof(Unity.Transforms.CopyInitialTransformFromGameObjectSystem))]
	public class FixedCopyTransformSystem : JobComponentSystem
	{
		...
		{
			m_TransformGroup = GetComponentGroup(ComponentType.ReadOnly(typeof(FixedCopyTransform)),typeof(UnityEngine.Transform));
		}
